                ...
                if nrof_faces > 0:
                    ...
                    for i in range(nrof_faces):
                        ...
                        if best_class_probabilities>0.53:
                            ...
                            frame[bb[i][1]+(int)((bb[i][3]-bb[i][1])*2/3), bb[i][0]+(int)((bb[i][2]-bb[i][0])/3)]=[0,0,255]
                            frame[bb[i][1]+(int)((bb[i][3]-bb[i][1])*2/3), bb[i][0]+(int)((bb[i][2]-bb[i][0])*2/3)]=[0,0,255]
                            left=gray[bb[i][1]+(int)((bb[i][3]-bb[i][1])*2/3), bb[i][0]+(int)((bb[i][2]-bb[i][0])/3)]
                            right=gray[bb[i][1]+(int)((bb[i][3]-bb[i][1])*2/3), bb[i][0]+(int)((bb[i][2]-bb[i][0])*2/3)]
                            print(right,left)
